...
class TestList:
    async def test_returns_items(self, recorder):
        ...
        resp = await client.drive.permissions.list("doxcabc", type="docx")
...
class TestCreate:
    async def test_posts_member(self, recorder):
        ...
        resp = await client.drive.permissions.create("doxcabc", MEMBER, type="docx")
...
class TestPublic:
    async def test_get_public(self, recorder):
        ...
        resp = await client.drive.permissions.get_public("doxcabc", type="docx")
        method, path, params, _ = recorder.last
    ...
    async def test_set_public(self, recorder):
        ...
        resp = await client.drive.permissions.set_public("doxcabc", settings, type="docx")
        method, path, params, body = recorder.last
