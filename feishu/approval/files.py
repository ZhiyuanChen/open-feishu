...
def approval_file_type_for_media_type(media_type: str | None) -> str:
    r"""
    Return the Feishu approval file type for a MIME type.
    """
...
def approval_file_code(upload_response: Mapping[str, Any]) -> str | None:
    r"""
    Extract the approval file ``code`` from known upload response shapes.
    """
...
def normalize_approval_file_upload_response(
    ...
    *,
    ...
    r"""
    Normalize an approval file upload response into a small status object.
    """
